...
const time = "Waktu";
const queueNumber = "Nomor Antrian";
const askingHint = "Masukan pertanyaan Mu";
...
const btnSend = "Kirim";
const dontHaveAnAccountYet = "Belum punya akun ? ";
const alreadyHaveAnAccount = "Sudah punya akun ? ";
const registerText = "Yuk Daftar!";
const loginText = "Silahkan Masuk!";

// text splash
const developer = "Fransisco S B Thorison";
const nim = "\n155410123";

const features = "Fitur";

// text nav & app bar
const navBarTextHome = "Beranda";
const navBarTextQna = "Tanya Jawab";
const navBarTextReservasi = "Reservasi";
const navBarTextProfile = "Profile";

// empty screen
const emptyReservasiTitle = "Reservasi Kosong";
const emptyReservasiSubtitle =
    "Anda belum melakukan reservasi. Buat reservasi untuk melakukan pemeriksaan gigi pada halaman ";
const emptyQnaTitle = "Tanya Jawab Kosong";
const emptyQnaSubtitle =
    "Ajukan pertanyaan Anda terkait kesehatan gigi Anda pada halaman ";

const answer = "Jawaban : ";

const ask = "Pertanyaan";
const textAnswer = "Jawaban";

const note = "Note : Datanglah 30 menit sebelum jadwal yang\ntelah ditentukan";

const subtitleReservasi = "Buat reservasi untuk periksa ke dokter";
const subtitleQna = "Ajukan pertanyaan seputar kesehatan gigi";

const tips1 = "Tips & Trik Merawat Gigi Part 1";
const tips2 = "Tips & Trik Merawat Gigi Part 2";
const tips3 = "Tips & Trik Merawat Gigi Part 3";

const pending = "Menunggu...";

const asking = "Ajukan Pertanyaan Mu";

const tipsTitle = "Tips & Trik";

const subtitle1 = "1. Menyikat gigi dengan benar";
const subtitle2 = "2. Pilih sikat gigi yang sesuai";
const subtitle3 = "3. Gunakan pasta gigi yang mengandung fluoride";
const subtitle4 = "4. Bersihkan bagian lidah";
const subtitle5 = "5. Lakukan flossing";
const subtitle6 = "6. Jangan lupa menggosok gigi sebelum tidur";
const subtitle7 = "7. Menggunakan obat kumur";
const subtitle8 = "8. Konsumsi sayur dan buah";
const subtitle9 = "9. Minum air putih";
const subtitle10 = "10. Kurangi makanan yang asam dan bergula";
const subtitle11 = "11. Hindari merokok";
const subtitle12 = "12. Periksa gigi secara rutin";
...
const aboutApp = "Tentang Aplikasi";
const aboutAppDesc = "Ketahui tentang aplikasi ini";
